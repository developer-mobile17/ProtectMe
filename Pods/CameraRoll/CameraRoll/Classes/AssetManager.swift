...
public class AssetManager {
    ...
    public static let sharedInstance = AssetManager()
...
//            }
    ...
    public func getImageFromAsset(phAsset: PHAsset, completion: @escaping (_ assetImage: UIImage) -> Void) {
    ...
    public func getVideoFromAsset(phAsset: PHAsset, completion: @escaping (_ video: AVAsset) -> Void) {
    ...
    public func getOriginal(phAsset: PHAsset, completion: @escaping (_ assetImage: UIImage) -> Void) {
