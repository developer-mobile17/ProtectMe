...
open class SideMenuManager : NSObject {
    ...
    public static var menuRightNavigationController: UISideMenuNavigationController? {
        ...
        didSet {
            ...
            setupNavigationController(menuRightNavigationController, leftSide: true)
        }
    }
    
    fileprivate
    class func setupNavigationController(_ forMenu: UISideMenuNavigationController?, leftSide: Bool) {
