...
open class UISideMenuNavigationController: UINavigationController {
    ...
    override open func viewWillTransition(to size: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        NotificationCenter.default.removeObserver(SideMenuTransition.singleton, name: UIApplication.didEnterBackgroundNotification, object: nil)
        coordinator.animate(alongsideTransition: { (context) in
            SideMenuTransition.presentMenuStart()
        }) { (context) in
            NotificationCenter.default.addObserver(SideMenuTransition.singleton, selector:#selector(SideMenuTransition.handleNotification), name: UIApplication.didEnterBackgroundNotification, object: nil)
        }
    }
